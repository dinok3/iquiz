    ...
    return (
        <div className="auth_grid">
            <div className="auth__container">
                ...
                <form method="POST" className="auth__form register_form" onSubmit={registerUser}>
                    <section>
                        ...
                        <>
                            ...
                            <p className="warning-info">{registerData.username}</p>
                        </>
                        }
                    </section>
                    <section>
                        ...
                        <>
                            ...
                            <p className="warning-info">{registerData.password}</p>
                        </>
                        }
                    ...
                    <section>
                        ...
                        {registerData.password2 === undefined ? 
                            <input type="password" name="password2" className="btn text-cursor"  /> :
                        <>
                            <input type="password" name="password2" className="btn red-border text-cursor" />
                            <p className="warning-info">{registerData.password2}</p>
                        </>
                        }

                    </section>
                    <input type="submit" value="REGISTER" name="submit"  className="btn submit-auth-btn" />
                </form>
                ...
                <p className="form-footer">
                    Already have an account? <Link to="/login/" className="footer-a">Login here!</Link>
                </p>
            </div>
